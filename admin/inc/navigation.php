...
.navbar-dark{
  background: linear-gradient(to right, #ob3e4d, #1b7278, #oe6574) !important;
  
}
.btn-rounded{border-radius: px;
}
...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-primary elevation-4 sidebar-no-expand">
        ...
        <li class="nav-item dropdown">
       <a href="<?php echo base_url ?>" class="nav-link nav"><?php echo (!isMobileDevice()) ? $_settings->info('name'):$_settings->info('short_name'); ?> - Adminview1</a><i class="nav-icon fas fa-cogs"></i>
          </li>
